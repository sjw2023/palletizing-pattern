...
public class Diagonal extends AbstractPattern {
    ...
    public Diagonal(AbstractPattern abstractPattern) {
        ...
        init(abstractPattern.getPatternType());
    }
    ...
    private void init(String patternType) {
    ...
    public boolean isPossible() {
        ...
        return ((palletInfo.getWidth() - productInfo.getLength()) / productInfo.getWidth() > 1) && ((palletInfo.getLength() - productInfo.getWidth()) / productInfo.getLength() > 1);
    }
    ...
    private boolean checkOuterPossible(int outerLevel) {
        return outerLevel * productInfo.getLength() + productInfo.getWidth() < palletInfo.getWidth() && outerLevel * productInfo.getWidth() + productInfo.getLength() < palletInfo.getLength();
    }
    ...
    private boolean addFirstRectanglePattern(DiagonalProductList diagonalProductList) {
        ...
        diagonalProductList.addProductAreaInfo(new ObjectAreaInfo(productInfo, Coordinate.builder().x((int) (productInfo.getLength() / 2)).y((int) (productInfo.getWidth() / 2)).z((int) (productInfo.getHeight() / 2)).build(), false));
        var lastInfo = diagonalProductList.getLastProductAreaInfo();
        diagonalProductList.addProductAreaInfo(new ObjectAreaInfo(productInfo, Coordinate.builder().x((int) (lastInfo.getOrigin().getX() + productInfo.getLength() + productInfo.getWidth() / 2)).y((int) (lastInfo.getOrigin().getY() + productInfo.getLength() / 2)).z((int) (productInfo.getHeight() / 2)).build(), true));
        lastInfo = diagonalProductList.getLastProductAreaInfo();
        diagonalProductList.addProductAreaInfo(new ObjectAreaInfo(productInfo, Coordinate.builder().x((int) (lastInfo.getEnd().getX() - productInfo.getLength() / 2)).y((int) (lastInfo.getEnd().getY() + productInfo.getWidth() / 2)).z((int) (productInfo.getHeight() / 2)).build(), false));
        lastInfo = diagonalProductList.getLastProductAreaInfo();
        diagonalProductList.addProductAreaInfo(new ObjectAreaInfo(productInfo, Coordinate.builder().x((int) (lastInfo.getEnd().getX() - productInfo.getWidth() / 2 - productInfo.getLength())).y((int) (lastInfo.getEnd().getY() - productInfo.getLength() / 2)).z((int) (productInfo.getHeight() / 2)).build(), true));
        return true;
    }
...
//                diagonalProductList.addIncreasedXYFromOriginFromIthProduct(i, productInfo.getWidth() + productInfo.getWidth() / 2, productInfo.getLength() / 2, true);
//                diagonalProductList.addProductAreaInfo(
//                        new ObjectAreaInfo(productInfo, Coordinate.builder()
//                                .x((int) (firstProductInfoOfLastOuterLayer.getOrigin().getX() + ))
//                                .y((int) (firstProductInfoOfLastOuterLayer.getOrigin().getY() + ))
...
//            } else {
                if (!makeTurn) {
                    ...
                    if (i == mid) {
                        ...
                        diagonalProductList.addProductAreaInfo(new ObjectAreaInfo(productInfo, Coordinate.builder().x((int) (lastInfo.getOrigin().getX() + productInfo.getWidth() / 2)).y((int) (lastInfo.getOrigin().getY() + productInfo.getLength() + productInfo.getLength() / 2)).z((int) (productInfo.getHeight() / 2)).build(), true));
                    }
                } else {
                    diagonalProductList.addIncreasedXYFromOriginEndFromIthProduct(0, -productInfo.getWidth() / 2, -productInfo.getLength() / 2, true);
//                    var lastInfo = diagonalProductList.getLastProductAreaInfo();
//                    diagonalProductList.addProductAreaInfo(
//                            new ObjectAreaInfo(productInfo, Coordinate.builder()
